...
public class ProjectContentProvider extends ContentProvider {
    ...
    public static final Uri CONTENT_URI = Uri.parse("content://cite.ansteph.ponda.contentprovider.projectcontentprovider/ponda");
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        int retVal = db.delete(Tables.PROJECT_TABLE, selection,selectionArgs);
    ...
    public Uri insert(Uri uri, ContentValues inValues) {
        ...
        long rowId = db.insert(Tables.PROJECT_TABLE, ProjectColumns.NAME, values);
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        {
            orderBy = ProjectColumns.NAME;
        }else {
            orderBy =sortOrder;
        }

        Cursor c = db.query(Tables.PROJECT_TABLE, projection,selection,selectionArgs,null,null,orderBy);
    ...
    public int update(Uri uri, ContentValues values, String selection,
        ...
        int retVal = db.update(Tables.PROJECT_TABLE, values, selection,selectionArgs);
        getContext().getContentResolver().notifyChange(uri, null);

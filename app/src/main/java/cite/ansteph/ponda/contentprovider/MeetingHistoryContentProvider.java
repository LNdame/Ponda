...
public class MeetingHistoryContentProvider extends ContentProvider {
    ...
    public static final Uri CONTENT_URI = Uri.parse("content://cite.ansteph.ponda.contentprovider.meetinghistorycontentprovider/ponda");
    private SQLiteDatabase db;

    public DbHelper databhelper ;

    public MeetingHistoryContentProvider() {
    }

...
public class ClientContentProvider extends ContentProvider {
    ...
    public static final Uri CONTENT_URI = Uri.parse("content://cite.ansteph.ponda.contentprovider.clientcontentprovider/ponda");
    private SQLiteDatabase db;

    public DbHelper databhelper ;

    public ClientContentProvider() {
    }

    @Override
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        // Implement this to handle requests to delete one or more rows.
        int retVal = db.delete(Tables.CLIENT_TABLE, selection,selectionArgs);
    ...
    public Uri insert(Uri uri, ContentValues inValues) {
        ...
        long rowId = db.insert(Tables.CLIENT_TABLE, ClientColumns.NAME, values);
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        {
            orderBy = ClientColumns.NAME;
        }else {
            orderBy =sortOrder;
        }

        Cursor c = db.query(Tables.CLIENT_TABLE, projection,selection,selectionArgs,null,null,orderBy);
    ...
    public int update(Uri uri, ContentValues values, String selection,
        ...
        int retVal = db.update(Tables.CLIENT_TABLE, values, selection,selectionArgs);
        getContext().getContentResolver().notifyChange(uri, null);

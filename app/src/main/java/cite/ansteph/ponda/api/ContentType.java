...
public class ContentType {
    ...
    public static final Uri ATTENDANCE_CONTENT_URI = Uri.parse("content://cite.ansteph.ponda.contentprovider.attendancecontentprovider/ponda");
    public static final Uri APOLOGY_CONTENT_URI = Uri.parse("content://cite.ansteph.ponda.contentprovider.apologycontentprovider/ponda");
